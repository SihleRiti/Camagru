...
<div class="clear"></div>    
    ...
    <div style="display: flex;">
        <img src="../img/one.png" alt="Birthday" style="width: 400px;height:300px; flex:1;" onclick="superpossable(this)">
        <img src="../img/gold.png" alt="spectacles" style="width:400px; height:300px; flex:1;" onclick="superpossable(this)">
        <img src="../img/flock.png" alt="Love" style="width:400px; height:300px; flex:1;" onclick="superpossable(this)">
        <img src="../img/frame.png" alt="Love" style="width:400px; height:300px; flex:1;" onclick="superpossable(this)">
    </div>
    </div>
